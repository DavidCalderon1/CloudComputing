<?php
	...
	if(isset($patRon) && isset($opCion)){
		...
		$resUlt=busqueda_cliente($patRon,$opCion,$iniCio,6);
...
?>
		...
		<tr>
			...
			<td align='center'>
				...
				<script type="text/javascript">
					...
					$(document).ready(function() {
						...
						$("#frm_sch").parent().find("#update<?php echo $i;?>").click(function() {
							$('#temporal').html('');
							reloadPest('Modificar_Cliente',"cliente/actualizar_cliente.php?id=<?php echo $resUlts['IdCliente'];?>");
						});
						$("#frm_sch").parent().find("#delete<?php echo $i;?>").click(function() {
							...
							if(confirmar()){
								...
								$.post("cliente/borrar_cliente.php?id=<?php echo $resUlts['IdCliente'];?>", {}, function(output){
								...
								if(output=="1" || output==1){
									...
									$('#temporal').html('');
									reloadPest("buscar_cliente","cliente/busqueda_cliente.php");
								}else if(output=="0" || output==0){
									var alerrr="Este cliente tiene facturas asociadas a el, no se puede borrar.";
				...
				<a href='#'	title="Ver Cliente" id="view<?php echo $i;?>"><img src='img/viewmag-icono.png'></a>
				<a href="#"	title="Modificar Cliente" id="update<?php echo $i;?>"><img src='img/editar-icono-32.png'></a>	
				<a href='#'	title="Eliminar Cliente" id="delete<?php echo $i;?>"><img src='img/borrar-icono-32.png'></a>
			</td>
		</tr>
...
<table align="right" style="width: 14%;margin-right: 5%;text-align: right;">
    ...
    $(document).ready(function() {
      ...
      $(".buscar_cliente #backBC").click(function() {
        $(".buscar_cliente #subsp").load("cliente/busqueda-cliente.php?pos=<?php if(isset($anteRior)){echo $anteRior;}?>&opCion=<?php echo $opCion;?>&patRon=<?php echo $patRon;?>").show();
      });
      
      $(".buscar_cliente #nextBC").click(function() {
        $(".buscar_cliente #subsp").load("cliente/busqueda-cliente.php?pos=<?php if(isset($proXimo)){echo $proXimo;}?>&opCion=<?php echo $opCion;?>&patRon=<?php echo $patRon;?>").show();
      });
