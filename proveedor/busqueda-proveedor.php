<?php
	...
	if(isset($patRon) && isset($opCion)){
		...
		$resUlt=busqueda_proveedor($patRon,$opCion,$iniCio,6);
...
?>
		...
		<tr>
			...
			<td align='center'>
				...
				<script type="text/javascript">
					...
					$(document).ready(function() {
						...
						$("#frm_sch").parent().find("#update<?php echo $i;?>").click(function() {
							$('#temporal').html('');
							reloadPest('Modificar_Proveedor',"proveedor/actualizar_proveedor.php?id=<?php echo $resUlts['IdProveedor'];?>");
						});
						$("#frm_sch").parent().find("#delete<?php echo $i;?>").click(function() {
							...
							if(confirmar()){
								...
								$.post("proveedor/borrar_proveedor.php?id=<?php echo $resUlts['IdProveedor'];?>", {}, function(output){
								...
								if(output=="1" || output==1){
									...
									$('#temporal').html('');
									reloadPest("buscar_proveedor","proveedor/busqueda_proveedor.php");
								}else if(output=="0" || output==0){
									var alerrr="Este proveedor tiene productos asociados a el, no se puede borrar.";
				...
				<a href='#'	title="Ver proveedor" id="view<?php echo $i;?>"><img src='img/viewmag-icono.png'></a>
				<a href="#"	title="Modificar proveedor" id="update<?php echo $i;?>"><img src='img/editar-icono-32.png'></a>	
				<a href='#'	title="Eliminar proveedor" id="delete<?php echo $i;?>"><img src='img/borrar-icono-32.png'></a>
			</td>
		</tr>
...
<table align="right" style="width: 14%;margin-right: 5%;text-align: right;">
    ...
    $(document).ready(function() {
      ...
      $(".buscar_proveedor #backBC").click(function() {
        $(".buscar_proveedor #subsp").load("proveedor/busqueda-proveedor.php?pos=<?php if(isset($anteRior)){echo $anteRior;}?>&opCion=<?php echo $opCion;?>&patRon=<?php echo $patRon;?>").show();
      });
      
      $(".buscar_proveedor #nextBC").click(function() {
        $(".buscar_proveedor #subsp").load("proveedor/busqueda-proveedor.php?pos=<?php if(isset($proXimo)){echo $proXimo;}?>&opCion=<?php echo $opCion;?>&patRon=<?php echo $patRon;?>").show();
      });
