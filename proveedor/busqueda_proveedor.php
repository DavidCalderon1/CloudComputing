    <script type="text/javascript">$.ajaxSetup({ cache: false });</script>
		<script type="text/javascript">
			$(document).ready(function(){
				...
				$("#frm_sch #pat").keyup(function(){
					$.post('proveedor/busqueda-proveedor.php', {patRon:$('#frm_sch #pat').val(), opCion:$('#frm_sch input[name="rd1BC"]:checked').val()}, function(result) {
						$(".buscar_proveedor #subsp").html(result).show();
					});
				});
		...
		<table width="90%" align="center">
			<tr>
				<td>
					<h3>Busqueda de proveedores</font></h3>
				</td>
			</tr>
		</table>
